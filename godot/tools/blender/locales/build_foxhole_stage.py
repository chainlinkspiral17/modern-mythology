...
def build_drums():
    ...
    # clear of the N wall (2026-09-24: the cymbal's rim 7 cm into it)
    make_cyl("Drum_CymStandL", (dx-0.58, dy+0.07, dz+0.45), 0.015, 0.90, chrome)
    make_cyl("Drum_CymL", (dx-0.58, dy+0.07, dz+0.90), 0.22, 0.02, brass, segments=16)
...
def build_pa():
    for si, sx in enumerate([-2.75, 2.75]):
        ...
        make_box(f"PA_{si}_Top", (sx, sy, 1.30), (0.52, 0.52, 1.20), (0.14,0.12,0.11,1.0))
