"""Diego's Bedroom — vol6 placement script."""
import os, sys
...
def build_dressing():
    """Diego's-room dressing: nightstand + clock, a soccer ball, a
    dresser, a floor plant (make_floor_plant was imported/unused), and
    a desk chair."""
    bx, by = -ROOM_W/4.0, ROOM_D/2.0
    ...
    make_cyl("SoccerBall", (0.4, 1.0, 0.14), 0.14, 0.28, (0.94, 0.94, 0.92, 1.0), segments=12)
    # Desk chair
    dx, dy = +ROOM_W/4.0, 1.5
