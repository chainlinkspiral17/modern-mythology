...
def build_shell():
    ...
    make_wall("Wall_S_W", (-3.0, 0.0, 0), length=3.0, height=CEIL, axis='X', palette=PAL, baseboard_face_sign=+1)
    make_wall("Wall_S_E", (+3.0, 0.0, 0), length=3.0, height=CEIL, axis='X', palette=PAL, baseboard_face_sign=+1)
