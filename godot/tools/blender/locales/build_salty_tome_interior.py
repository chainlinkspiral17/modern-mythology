...
def build_alley_2026_09():
    ...
    make_box("Nebula_Band_Rose", (-2.4, AL_Y1 - 0.098 - 0.0256, 1.10), (1.8, 0.006, 0.55), (0.62, 0.32, 0.42, 1.0))
    make_box("Nebula_Star_Core", (2.2, AL_Y1 - 0.097 - 0.0261, 2.45), (0.34, 0.005, 0.34), (0.88, 0.84, 0.66, 1.0))
