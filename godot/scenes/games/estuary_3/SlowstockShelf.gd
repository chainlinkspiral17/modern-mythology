...
const FULL_MANIFESTS: Dictionary = {
	...
	"riffrocker_melody_club": "res://resources/games/vol7/riffrocker_melody_club/manifest.json",
...
func open() -> void:
	...
	_refresh_finished()
	AudioMgr.request_scene_bgm("res://assets/audio/bgm/shelf/cabin_ambient.wav")
