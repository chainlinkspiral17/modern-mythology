...
func open_scenario_picker() -> void:
	...
	add_child(picker)
	var entries: Array = [
		{"launch_fn": Callable(self, "launch_pre_dawn_quiet"), "title": "PRE-DAWN QUIET", "subtitle": "WGUR Transmitter Shack · 4:38 AM · the first quiet in seven hours", "difficulty": "easy"},
		{"launch_fn": Callable(self, "launch_render_queue"), "title": "RENDER QUEUE", "subtitle": "WGUR Transmitter Shack · 2:04 AM · the night the carrier wouldn't drop", "difficulty": "hard"},
		{"launch_fn": Callable(self, "launch_the_clear_morning"), "title": "THE CLEAR MORNING", "subtitle": "WGUR Transmitter Shack · 9:18 AM · two days later · the FCC inspector at the gate", "difficulty": "hard"},
	]
