	...
	if event is InputEventKey and event.pressed and not event.echo:
		...
		if k.ctrl_pressed:
			...
			if k.keycode == KEY_F10:
				launch_the_relief_techs_arrival()
			elif k.keycode == KEY_F11:
				launch_the_storm_visit()
...
func launch_watch_kept() -> void:
	_launch_scenario("hermit", "bayou_lighthouse", "tbd_hermit",
	                 "watch_kept", true)


func launch_the_relief_techs_arrival() -> void:
	_launch_scenario("hermit", "bayou_lighthouse", "tbd_hermit",
	                 "the_relief_techs_arrival", false)


func launch_the_storm_visit() -> void:
	_launch_scenario("hermit", "bayou_lighthouse", "tbd_hermit",
	                 "the_storm_visit", true)
...
func open_scenario_picker() -> void:
	...
	add_child(picker)
	var entries: Array = [
		{"launch_fn": Callable(self, "launch_the_relief_techs_arrival"), "title": "THE RELIEF TECH'S ARRIVAL", "subtitle": "Bayou Lighthouse · 11:14 AM Friday · the day the automation crew comes", "difficulty": "easy"},
		{"launch_fn": Callable(self, "launch_watch_kept"), "title": "WATCH KEPT", "subtitle": "Bayou Lighthouse · 2:47 AM · the last week of the manned station", "difficulty": "medium"},
		{"launch_fn": Callable(self, "launch_the_storm_visit"), "title": "THE STORM VISIT", "subtitle": "Bayou Lighthouse · 11:48 PM · the night a skiff lost its outboard in the squall", "difficulty": "hard"},
	]
