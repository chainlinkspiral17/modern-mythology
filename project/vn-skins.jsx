...
const VOLUME_LIST = [
  ...
  { vol: 5,  title: 'Major Arcana',             subtitle: 'Volume V',   skin: 'arcana',    unlocked: false, progress: 'Locked'       },
  { vol: 6,  title: 'Planned Community',        subtitle: 'Volume VI',  skin: 'suburban',  unlocked: false, progress: 'Locked'       },
  { vol: 7,  title: 'Land of Milk & Honey',     subtitle: 'Volume VII', skin: 'pastoral',  unlocked: false, progress: 'Locked'       },
...
const SKINS = {
  ...
  pastoral: {
    ...
    vars: {
      '--dlg-bg':'rgba(10,14,6,0.97)','--dlg-border':'rgba(120,160,60,0.35)',
      '--dlg-rule':'linear-gradient(90deg,transparent,rgba(120,160,60,0.6),rgba(200,180,80,0.6),rgba(120,160,60,0.6),transparent)',
      '--dlg-min-h':'210px','--dlg-pad':'28px 44px 24px',
      '--spk-color':'#a8c864','--spk-font':"'Cinzel',serif",'--spk-size':'11px','--spk-tracking':'0.22em','--spk-style':'normal',
      '--txt-color':'#c8d4a8','--txt-font':"'IM Fell English',serif",'--txt-size':'18px','--txt-style':'italic','--txt-weight':'400','--txt-lh':'1.72',
      '--ch-border':'rgba(120,160,60,0.2)','--ch-bg':'rgba(120,160,60,0.05)','--ch-hborder':'rgba(120,160,60,0.5)','--ch-hbg':'rgba(120,160,60,0.1)',
      '--ch-color':'#98b480','--ch-hcolor':'#c8d4a8','--ch-font':"'IM Fell English',serif",'--ch-size':'15px',
      '--hud-color':'rgba(120,160,60,0.45)','--hud-font':"'Cinzel',serif",
      '--cursor':'#a8c864','--nav-color':'rgba(120,160,60,0.35)',
      '--ov-bg':'rgba(6,8,4,0.97)','--ov-border':'rgba(120,160,60,0.2)','--ov-txt':'#c8d4a8',
